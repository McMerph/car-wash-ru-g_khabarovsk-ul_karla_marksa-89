import MonthHandler from '../../../main/app/model/MonthHandler';

test('getWeeks() method', () => {
    const february2027Handler: MonthHandler = new MonthHandler(new Date(2027, 1));
    const november2017Handler: MonthHandler = new MonthHandler(new Date(2017, 10));
    const april2018Handler: MonthHandler = new MonthHandler(new Date(2018, 3));

    expect(february2027Handler.getWeeks()).toEqual([
    ...
    expect(november2017Handler.getWeeks()).toEqual([
    ...
    expect(april2018Handler.getWeeks()).toEqual([
